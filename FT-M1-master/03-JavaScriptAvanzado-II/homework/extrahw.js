/* Crear un método `repeatify` que este disponible para _todos_ los objetos `Strings`. Esta función debe aceptar un `entero` 
que indica cuantas veces el string tiene que repetirse. La función retorna el string repetido el número de veces que indicamos. 
...
String.prototype.repeatify = function(cantidad) {
    var cadena = this
    if (cantidad < 0) {
     return "";
    } else {
